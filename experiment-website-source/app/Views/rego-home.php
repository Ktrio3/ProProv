...
<?= $this->section('content') ?>
    <div class="container-fluid">
        <div class="bg-light p-5 rounded-lg">
          ...
          <?php endif;?>
          <hr class="my-4">
          <p>In this section, you will use the Rego tool introduced in the last step to write a few provenance policies. Please attempt every problem at least once. If you are unable to solve the problem, after 2.5 minutes you will be allowed to move to the next question.</p>
          <hr class="my-4">
          ...
          <?php endif;?>
          <a href="<?= base_url("rego/1") ?>" class="btn btn-primary btn-lg">Begin</a>
        </div>
    </div> 
<?= $this->endSection() ?>